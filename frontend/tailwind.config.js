    ...
    extend: {
      colors: {
        ...
        secondary: {
          ...
          "accent-light": "hsl(var(--secondary-accent-light))",
        },
        success: {
      ...
      fontFamily: {
        'sans': ['Inter', 'SF Pro Display', 'PingFang SC', 'system-ui', '-apple-system', 'sans-serif'],
        'display': ['Manrope', 'Inter', 'system-ui', 'sans-serif'],
        'mono': ['JetBrains Mono', 'Fira Code', 'Monaco', 'Consolas', 'monospace'],
        'chinese': ['PingFang SC', 'Inter', 'sans-serif'],
      ...
      keyframes: {
        ...
        "wiggle": {
          "0%, 7%, 14%, 21%, 28%, 35%, 42%, 49%, 56%, 63%, 70%, 77%, 84%, 91%, 98%, 100%": { transform: "translateX(0px)" },
          "4%, 18%, 32%, 46%, 60%, 74%, 88%": { transform: "translateX(-3px)" },
          "11%, 25%, 39%, 53%, 67%, 81%, 95%": { transform: "translateX(3px)" },
        },
        "slide-up-fade": {
      ...
      animation: {
        ...
        "bounce-scale": "bounce-scale 0.5s ease-out",
